...
const TECHNOLOGIES = [
    ...
    {"value":"444","label":" Adobe"},
    {"value":"445","label":" Figma"},
    {"value":"446","label":" Corel Draw"},
    {"value":"447","label":" Agile"},
    {"value":"448","label":" Lumen"},
    {"value":"450","label":" Slim"},
    {"value":"452","label":" Photoshop"},
    {"value":"452","label":" Sketch"},
    {"value":"453","label":" Illustrator"},
    {"value":"454","label":" Invision"},
    {"value":"455","label":" Uxpin"},
    {"value":"456","label":" Quartx"},
];


const WHY_WOULD_YOU = [
    { label: 'Chocolate (are you crazy?)', value: 'chocolate', disabled: true },
].concat(TECHNOLOGIES.slice(1));
class Technology extends React.Component {
    ...
    componentDidMount() {
        GetData("/api/developer/technology").then((result) => {
            if (result.status === 1) {
    ...
    handleSelectChange=(value)=> {
        this.setState({ value });
        PostData('/api/developer/technology',{value:value}).then((result)=>{})
    };

    render () {
        const { crazy, stayOpen, value} = this.state;
        const options = crazy ? WHY_WOULD_YOU : TECHNOLOGIES;
        return (
            <div className="pf-field w3-container">
                <span className="pf-title">Professional Skills</span>
                <form>
                    <Select
