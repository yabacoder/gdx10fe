        ...
        <div>
            <div className="inset-0 flex w-screen h-screen">
                <div className="w-3/12 h-full px-16 py-8 overflow-hidden bg-white shadow-sm sidebar">
                    ...
                    <ul className="mt-10">
                    <Link to="/dashboard" >
                        <li className={(currentLocation === '/dashboard') ? 'text-blue-800 flex items-center p-5 font-getdevM text-sm' : 'flex items-center p-5 font-getdevM text-sm text-gray-500'}> 
                        <svg className="p-1 fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 18 19">
                        ...
                        <Link to="/project">
                        <li className={(currentLocation === '/project') ? 'text-blue-800 flex items-center p-5 font-getdevM text-sm' : 'flex items-center p-5 font-getdevM text-sm text-gray-500'}> 
                        
                                <svg className="p-1 fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 23.074 21.92">
                        ...
                        {/* <Link to="/assessment">
                        <li className={(currentLocation === '/assessment') ? 'text-blue-800 flex items-center p-5 font-getdevM text-sm' : 'flex items-center p-5 font-getdevM text-sm text-gray-500'}> 
                        <svg className="p-1 fill-current" xmlns="http://www.w3.org/2000/svg" width="25.847" height="24" viewBox="0 0 25.847 18.093">
                        ...
                        <Link to="/portfolio">
                        <li className={(currentLocation === '/portfolio') ? 'text-blue-800 flex items-center p-5 font-getdevM text-sm' : 'flex items-center p-5 font-getdevM text-sm text-gray-500'}> 
                        <svg className="p-1 fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 19.001 19">
                        ...
                        Account
                         ...
                         <Link to="/logout">
                            ...
                            <svg className="p-1 fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16.571 17.403">
