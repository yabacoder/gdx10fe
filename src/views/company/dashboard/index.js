        ...
        <>
            <div>
                <div className="flex items-center justify-between intro">
                    ...
                    <div className="flex items-center justify-between w-2/3 ml-5 h-42 boxes">
                        <div className="w-1/2 ">
                            <div className="px-10 py-5 mx-3 text-center text-gray-600 bg-white rounded-lg shadow-lg addJob">
                                <h5 className="text-blue-800">Add a Job</h5>
                                <p className="my-2 leading-4 text-gray-500">You're here to hire someone right? Creating and activating a position is the first step towards that.</p>
                                <div className="flex justify-around w-full px-3 py-3 my-3 text-sm text-red-600 bg-red-200 rounded-md">Get Started
                        ...
                        <div className="w-1/2 ">
                            <div className="px-10 py-5 mx-3 text-center text-white bg-blue-500 rounded-lg shadow-lg ">
                                ...
                                <div class="flex justify-around w-full my-3 px-3 py-3 text-sm  bg-blue-200 rounded-md text-blue-500">Get Started
                ...
                <div className="flex items-center justify-between w-full p-5 px-8 py-8 mt-10 text-center bg-white rounded-md shadow-md">
                    ...
                    <div>
                        <h3 className="text-yellow-400">3</h3>
                        <p>Active Jobs</p>
                    </div>
                    <div>
                        <h3 className="text-red-400">2</h3>
                        <p>New Candidates</p>
                    </div>
                    <div>
                        <h3 className="text-blue-400">5</h3>
                        <p>Shortlisted Candidates</p>
                    </div>
                    <div>
                        <h3 className="text-teal-400">9</h3>
                ...
                <div className="flex justify-between w-full px-8 py-8 mt-10 bg-white rounded-md shadow-md">
                    <div className="w-1/2 px-5">
                        <p>Jobs</p>
                        <div className="p-10 my-3 text-gray-500 bg-gray-200 rounded-md">
                            <p>Sorry, you currently do not have a job listed.</p>
                                ...
                                <div className="flex flex-col justify-between px-4 py-4 my-3 bg-white border border-gray-400 rounded-md ">
                                    <div className="flex justify-between">
                                        <div >
                                            ...
                                            <p className="text-blue-800">    <span><svg xmlns="http://www.w3.org/2000/svg" className="inline-flex w-4 mx-1" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <div className="mt-5 info">
                                        <ul className="flex items-center">
                                            ...
                                            <li className="px-4 py-1 ml-auto text-sm border rounded-full cursor-pointer"> See Candidate</li>
                                        </ul>
                                    </div>
