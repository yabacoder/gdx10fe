    ...
    return (
        <div className="bg-white rounded-md p-4 px-6">
                ...
                <div className="jobs flex flex-col">
                    <div className="my-3 border border-gray-400 bg-gray-200 py-4 px-6 w-full inline-flex rounded-md  ">

                            <div className="w-2/12 text-center mr-2" >
                         
                            <ul>
                            <li className="border font-getdevB text-xs border-gray-600 bg-gray-400 text-blue-700 rounded-full bg-opacity-50  px-4">
                                    Html
                            </li>
                            </ul>
...
<div class="shadow rounded-full w-10/12 bg-gray-500">
  <div class="bg-yellow-600 text-xs rounded-full leading-none py-1 text-center text-white w-5/12" >45%</div>
</div>
...
<div class="shadow rounded-full w-10/12 bg-gray-500">
<div class="bg-green-500 text-xs rounded-full leading-none py-1 text-center text-white w-9/12" >75%</div>
</div>
<p className="text-xs"></p>
</div>
