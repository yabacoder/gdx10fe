  ...
  <g fill="#8691b0" data-name="Group 1256" transform="translate(-787 -96)">
    ...
    <circle cx="2.5" cy="2.5" r="2.5" data-name="Ellipse 640" transform="translate(787 110)"/>
                    ...
                    <div className="flex p-3 right">
                        ...
                        <div className="ml-3">
                            <button onClick={() => setModalIsOpen(true)} className="flex justify-between p-2 bg-blue-500 rounded btn">
                                Invite Interviewer
                 ...
                 className="" >
                    <div className="flex flex-col p-10 rounded-md">
                        ...
                        <div className="flex justify-between mt-10">
                            <button className="px-5 py-3 bg-red-600 btn">
                                Invite
                            </button>
                            <button onClick={() => setModalIsOpen(false)} className="text-gray-600 transition duration-200 ease-in-out border btn hover:bg-gray-600 hover:text-white">
                                Cancel
                            </button>
                        </div>
                        </div>
