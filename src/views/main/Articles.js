...
const Articles = () => {
    ...
    return (
        ...
        // <Layout>
        <section className="px-6 py-10 bg-white rounded-md shadow-lg md:px-20 md:mx-20">
            <div className="mt-20 mb-4 section-header md:mt-0">
            ...
            <div className="mt-10 talent-cards">
