                ...
                <div className="hidden w-full px-2 lg:flex lg:items-center lg:w-auto " id="menu">
                    <nav>
                        <ul className="items-center justify-between pt-4 text-base text-white lg:flex lg:pt:0">
                            <li>
                                <Link to="/pricing" className="py-1 text-white md:mx-6 font-getdevM ">For Companies </Link>
                            </li>
                            <li>
                                <Link to="/pricing" className="py-1 mt-1 text-white md:mx-6 font-getdevM">How it works</Link>
                            </li>
                            {/* <li>
